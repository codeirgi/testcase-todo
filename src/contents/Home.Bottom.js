...
const HomeBottom = () => {
    return(
        <Cards.Home className="home-bottom">
            ...
            <ol>
                <li>Anda dapat membuat <span>To Do</span> baru dengan menekan icon <img src={plus} width={16} height={16} /> (tambah)</li>
                ...
                <li>Anda bisa merubah status <span>To Do</span> anda dengan cepat dengan menekan icon <img src={check} width={16} height={16} /> dan icon <img src={minus} width={16} height={16} /></li>
